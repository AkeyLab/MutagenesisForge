...
@cli.command()
@click.option(
    "--vcf", prompt="path to reference vcf file", help="path to reference vcf file"
)
@click.option("--bed", prompt="path to bed file", help="path to bed file")
@click.option("--fasta", prompt="path to fasta file", help="path to fasta file")
@click.option(
    "--model",
...
@click.option("--output", default="output.vcf", help="output name")
@click.option("--sims", default=1, help="number of simulations")
@click.option("--vep_call", default=False, help="run vep call")
@click.option("--alpha", default=None, help="alpha parameter")
@click.option("--beta", default=None, help="beta parameter")
@click.option("--gamma", default=None, help="gamma parameter")
# context model
...
@click.option("--by-read", is_flag=True, help="Calculate dN/dS by gene")
